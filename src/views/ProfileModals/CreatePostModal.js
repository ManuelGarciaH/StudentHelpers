            ...
            <Text style={styles.textModal}>Elige una categoria</Text>
                ...
                <View style={[styles.buttonContainer, {marginTop: 7}]}>
                    ...
                    {getValues("category") == "Viaje" ? (
                      <TravelRouteButton control={control} errors={errors} name="lugar" setValue={setValue} 
